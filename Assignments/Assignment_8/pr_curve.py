...
def main():
    ...
    run_dir = f'{RUN_ROOT_DIR}/crop_False_flip_True_solarize_True_gauss_False_adam_gridv3_sf_32_negr20.0_nsm_0.3_lgminiou_0.5_nodes_4800_lr_0.0001_bs_16_2023-08-01_21-23-49'
    ...
    _, pr, rc = evaluate(model, val_dataloader, DEVICE, anchor_grid, nms_threshold=NMS_THRESHOLD, filter_threshold=0.0)
